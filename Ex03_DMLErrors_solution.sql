-- INSERT statements that conflicts with a FOREIGN KEY usally
-- tries to insert invalid values in the foreign key column.
-- If you inspect the values in the insert statements, you 
-- will find that we try to insert values in the Employees
-- table first, before any department is inserted. This means 
-- that the value for the 'dno' column doesn't exist. Again 
-- sequence is important.
-- Note that three of the insert statements actually succeeded,
-- which is the three statements that created departments. You 
-- should know be able to run the insert employee statements, 
